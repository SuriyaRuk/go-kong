...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LimitKeyQuota) DeepCopyInto(out *LimitKeyQuota) {
	*out = *in
	if in.Consumer != nil {
		in, out := &in.Consumer, &out.Consumer
		*out = new(Consumer)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LimitKeyQuota.
func (in *LimitKeyQuota) DeepCopy() *LimitKeyQuota {
	if in == nil {
		return nil
	}
	out := new(LimitKeyQuota)
	in.DeepCopyInto(out)
	return out
}
